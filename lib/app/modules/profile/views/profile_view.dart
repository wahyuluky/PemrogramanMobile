...
class ProfileView extends GetView<ProfileController> {
        ...
        child: Column(
          children: [
            ...
            buildProfileButton(
              ...
              Icons.arrow_right,
              onPressed: () {
                // Navigasi ke halaman History jika ada
                // Contoh:
                // Get.to(() => HistoryView());
              },
            ),
            buildProfileButton(
              ...
              Icons.arrow_right,
              onPressed: () {
                // Navigasi ke halaman Sertifikat jika ada
                // Contoh:
                // Get.to(() => SertifikatView());
              },
            ),
            buildProfileButton(
              context, 
              'Logout', 
              Icons.arrow_right, // Mengganti ikon untuk logout
              onPressed: () {
                // Implementasikan logika logout jika diperlukan
  ...
  // Modifikasi metode buildProfileButton untuk menerima callback onPressed
