...
class StrukturController extends GetxController {
  ...
  void addStruktur(String nama, String periode, String jabatan) async {
    try {
      ...
      strukturList.add(Struktur(id: docRef.id, nama: nama, periode: periode, jabatan: jabatan));
  ...
  void updateStruktur(String id, String nama, String periode, String jabatan) async {
    try {
      ...
      if (index != -1) {
        strukturList[index] = Struktur(id: id, nama: nama, periode: periode, jabatan: jabatan);
      }
